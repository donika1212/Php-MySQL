    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h2>Cars</h2>
       ...
       <form action="addCar.php" method="post">
        ...
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Car Model" name="car_model" >
          <label for="floatingInput">Car Model</label>
        </div>
        <div class="form-floating">
          <input type="number" class="form-control" id="floatingInput" placeholder="Car Mileage" name="car_mileage" >
          <label for="floatingInput">Car Mileage</label>
        </div>
        <div class="form-floating">
          <input type="number" class="form-control" id="floatingInput" placeholder="Car Price" name="car_price" >
          <label for="floatingInput">Car Price</label>
        </div>
        <div class="form-floating">
          <input type="file" class="form-control" id="floatingInput" placeholder="Car Image" name="car_image" >
