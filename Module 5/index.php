...
echo $dogs [0][0]. ":Origjin:" . $dogs [0][1] . ",Life Span:" . $dogs[0][2] . "<br>";
//Indexi i pare paraqet rreshtin kurse indexi i dyte parqet elementin brenda array
echo $dogs [1][0]. ":Origjin:" . $dogs [1][1] . ",Life Span:" . $dogs[1][2] . "<br>";
echo $dogs [2][0]. ":Origjin:" . $dogs [2][1] . ",Life Span:" . $dogs[2][2] . "<br>";
...
//Associative arrays-Jane array me indexa qe nuk jane me nr por me text
