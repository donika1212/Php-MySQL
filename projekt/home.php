  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    ...
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">Top pics</h1>
        <p class="lead text-muted">Here are our best selling cars. You are guaranteed the best quality and awasome prices</p>
    ...
    <div class="container">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          ...
          <div class="card shadow-sm">
            ...
            <img src="car_images/<?php echo $car_data['car_image'];  ?>" height="350">

            <div class="card-body">
              <h4><?php echo $car_data['car_model']; ?></h4>
