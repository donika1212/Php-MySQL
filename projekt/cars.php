      ...
      <h2>Cars</h2>
       ...
       <form action="addCar.php" method="post">
        ...
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Car Make" name="car_make" >
        ...
        <div class="form-floating">
          <input type="text" class="form-control" id="floatingInput" placeholder="Milage" name="movie_km" >
          <label for="floatingInput">Car Milage</label>
        </div>
        <div class="form-floating">
