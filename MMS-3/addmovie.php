...
$movie_image = $_POST["movie_image"];
    ...
    $sql = "INSERT INTO movies (movie_name,movie_desc,movie_quality,movie_ratng, moving_image) VALUES (:movie_name, :movie_desc, :movie_quality, :movie_rating, :movie_image)";
