...
$movie_image = $_POST["movie_image"];
    ...
    $sql = "INSERT INTO users1(movie_name,movie_desc,movie_quality,movie_rating,movie_image) VALUES (:movie_name, :movie_desc, :movie_quality, :movie_rating, :movie_image)";

    $insertMovie = $conn->perpare($sql);
