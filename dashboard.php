...
<div class="container mt-5">
        <div class="dashboard-container">
            <h2 class="mb-4 text-center">🍽️ Foods Dashboard</h2>
                    ...
                    <?php if (count($foods) > 0): ?>
                        <?php foreach ($foods as $food): ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($food['food_desc']); ?></td>
                                <td><?= number_format($food['food_price'], 2); ?></td>
                                <td>
                                    <?php if (!empty($food['food_image'])): ?>
                                        <img src="images/food/<?= $food['food_image']; ?>" width="100" height="80" class="food-img" alt="Food Image">
                                    <?php else: ?>
                                        <span>No image</span>
                                    <?php endif; ?>
                                </td>
