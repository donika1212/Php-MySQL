...
<head>
    ...
    height: 100vh;     /* Ensures the background covers full height of the viewport */
        ...
        body { font-family: Arial, sans-serif; background-color:rgb(50, 161, 175); margin: 0; padding: 0; text-align: center; }
        .navbar { background-color:rgba(0, 0, 0, 0.83); padding: 15px; }
        .navbar a { color: white; text-decoration: none; padding: 15px 15px; font-size: 18px; }
        .games { display: flex; justify-content: center; flex-wrap: wrap; gap: 15px; margin-top: 20px; }
        .game-card { background: rgba(54, 54, 54, 0.97); padding: 15px; border-radius: 5px; width: 250px; text-align: center; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1); }
        .game-card img { width: 100%; height: auto; border-radius: 5px; }
        .game-card h3 { margin: 10px 0; }
        .game-card a { display: block; margin-top: 10px; padding: 8px 12px; background-color:rgb(0, 0, 0); color: white; text-decoration: none; border-radius: 5px; }
    </style>
