...
<body class="bg-dark">
    <div class="container p-5 d-flex flex-column align-items-center">
        ...
        <form action="" method="post" class="form-control mt-5 p-4"
          ...
          style="text-align: center; color: bg-dark;"></i>
          ...
          style="font-weight: 700;">Login Into Your Account</h5>
            ...
            <div class="col mb-3 mt-3">
                <button type="submit" 
                  class="btn btn-success bg-dark" style="font-weight: 600;">Login</button>
            </div>
            <div class="col mb-2 mt-4">
                <p class="text-center" 
                  style="font-weight: 600; color: #636363;"
                  ><a href="./register.php"
                          class="login-link">Create Account</a> OR <a href="./resetpassword.php"
                         class="login-link">Forgot Password</a></p>
            </div>
        </form>
    </div>
    <script>
