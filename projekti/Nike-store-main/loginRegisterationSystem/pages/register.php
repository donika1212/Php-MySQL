    ...
    <div class="container p-5 d-flex flex-column align-items-center">
        ...
        <form method="post" class="form-control mt-5 p-4"
            ...
            <div class="row text-center">
                <i class="fa fa-user-circle-o fa-3x mt-1 mb-2" style="bg-dark"></i>
            ...
            <div class="mb-2 mt-3">
                ...
                bg-dark" style="color: white; font-weight: 600;">Create
                    Account</button>  
            </div>
            <div class="mb-2 mt-4">
                <p class="text-center" style="font-weight: 600; 
                color: grey;">I have an Account <a href="./login.php" class="login-link">
                Login</a></p>
            </div>
        </form>
    </div>
